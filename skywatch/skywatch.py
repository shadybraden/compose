...
for ac in data.get('aircraft', []):
    ...
    if callsign.startswith("GKA"):
        print(callsign)
        send_message = 1
        priority = 'default'
        title = "Golden Knights Parachuters | " + short_type_value + " | " + desc_value
